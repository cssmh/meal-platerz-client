...
const BePremium = () => {
  return (
    <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 rounded-md shadow-lg flex flex-col md:flex-row items-center justify-between my-7">
