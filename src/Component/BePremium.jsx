...
const BePremium = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-5 md:py-8 md:px-12 md:rounded-md shadow-lg flex flex-col md:flex-row items-center justify-between">
