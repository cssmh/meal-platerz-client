      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel
                className={`w-full max-w-${width} transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all`}
              >
                <Dialog.Title
                  as="h3"
                ...
                <form onSubmit={handleAddReview}>
                  <div className="mt-2">
                    <textarea
                      ...
                      rows="5"
                      defaultValue={review || ""}
                      className="w-full border p-2 rounded-lg resize-none focus:ring-1 focus:ring-green-500 focus:border-transparent"
