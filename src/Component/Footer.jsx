    ...
    <footer className="bg-[#030711] text-gray-300 p-10">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-3">
          ...
          <p>Email: contact@ymealplaterz.com</p>
        </div>
        <div className="space-y-3">
          <h2 className="text-lg font-semibold text-white">Our Office</h2>
          <p>Kharabor House 23, Ghatail</p>
          <p>Phone: +88015258543</p>
        </div>
      </div>
      <div className="flex justify-center items-center">
        <img src={bgImage} alt="Our Office" className="rounded-md" />
      </div>
      <div className="flex flex-col justify-center pt-6 lg:pt-0 mt-6">
        <div className="flex justify-center space-x-4">
          <a
            ...
            href="#"
            title="Instagram"
            className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-[#f01543] text-gray-50"
          >
            <svg
      ...
      <div className="mt-6 text-center text-gray-400 text-sm">
        <p>
          &copy; 2024 MealPlaterz. designed by{" "}
          <a href="http://facebook.com/touristmomen">Momen</a>{" "}
        </p>
      </div>
    </footer>
  );
